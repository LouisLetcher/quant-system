...
class StrategyFactory:
    ...
    @classmethod
    def create_strategy(cls, strategy_name: str, parameters: Optional[Dict[str, Any]] = None) -> Any:
        """
        ...
        raise ValueError(
            ...
            f"Available strategies: {available_all}"
        )
...
def create_strategy(strategy_name: str, parameters: Optional[Dict[str, Any]] = None) -> Any:
    """
