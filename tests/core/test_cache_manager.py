...
class TestUnifiedCacheManager:
    ...
    def test_cache_data(self, cache_manager, sample_dataframe):
        ...
        expected_path = os.path.join(cache_manager.cache_dir, 'data', f'{key}.parquet.gz')
    ...
    def test_cache_backtest_result(self, cache_manager, sample_backtest_result):
        ...
        # Verify file was created
        expected_path = os.path.join(cache_manager.cache_dir, 'backtests', f'{key}.json.gz')
        assert os.path.exists(expected_path)
    ...
    def test_get_backtest_result(self, cache_manager, sample_backtest_result):
        ...
        assert retrieved_result['total_return'] == sample_backtest_result['total_return']
    ...
    def test_clear_cache_by_type(self, cache_manager, sample_dataframe, sample_backtest_result):
    ...
    def test_compression(self, cache_manager, sample_dataframe):
        ...
        compressed_path = os.path.join(cache_manager.cache_dir, 'data', f'{key}.parquet.gz')
