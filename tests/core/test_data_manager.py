...
from src.core.data_manager import UnifiedDataManager, DataSource
...
class TestUnifiedDataManager:
    ...
    def test_fetch_yahoo_finance_data(self, mock_yf_download, data_manager, sample_data):
    ...
    def test_fetch_bybit_data(self, mock_get, data_manager):
        ...
        mock_response.json.return_value = {
            'result': {
                'list': [
                    ['1640995200000', '47000', '47500', '46500', '47200', '1000', '47000000'],
                    ['1641081600000', '47200', '47800', '46800', '47400', '1200', '56880000']
                ]
            }
        }
    ...
    @pytest.mark.parametrize("asset_type,expected_interval", [
        ('stocks', '1d'),
        ('crypto', '1h'),
        ('forex', '1d')
    ])
