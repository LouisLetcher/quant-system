...
class TestPortfolioManager:
    ...
    def test_add_portfolio(self, portfolio_manager):
        ...
        assert portfolio_manager.portfolios['test_portfolio']['name'] == 'Test Portfolio'
    ...
    def test_backtest_portfolio(self, portfolio_manager, sample_backtest_results):
        ...
        portfolio_manager.backtest_engine.batch_backtest.return_value = sample_backtest_results
    ...
    def test_compare_portfolios(self, portfolio_manager, sample_portfolios, sample_backtest_results):
    ...
    def test_calculate_portfolio_metrics(self, portfolio_manager, sample_backtest_results):
        """Test calculating portfolio-level metrics."""
        metrics = portfolio_manager._calculate_portfolio_metrics(sample_backtest_results)
    ...
    def test_generate_investment_recommendations(self, portfolio_manager, sample_portfolios, sample_backtest_results):
    ...
    def test_optimize_portfolio_allocation(self, portfolio_manager, sample_backtest_results):
    ...
    @pytest.mark.parametrize("risk_tolerance,expected_weights", [
    ...
    def test_get_risk_weights(self, portfolio_manager, risk_tolerance, expected_weights):
    ...
    def test_calculate_correlation_matrix(self, portfolio_manager, sample_backtest_results):
        """Test correlation matrix calculation."""
        correlation_matrix = portfolio_manager._calculate_correlation_matrix(sample_backtest_results)
    ...
    def test_diversification_score(self, portfolio_manager, sample_backtest_results):
        ...
        score = portfolio_manager._calculate_diversification_score(sample_backtest_results)
    ...
    def test_portfolio_performance_attribution(self, portfolio_manager, sample_backtest_results):
    ...
    def test_portfolio_summary_statistics(self, portfolio_manager, sample_backtest_results):
    ...
    def test_concurrent_portfolio_analysis(self, portfolio_manager, sample_portfolios, sample_backtest_results):
